...
public class CategoryItemProvider 
	...
	protected void addTagsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_tags_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_tags_feature", "_UI_Category_type"),
				 OffersPackage.Literals.CATEGORY__TAGS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OffersPackage.Literals.CATEGORY__PRODUCTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.CATEGORY__PRODUCTS,
